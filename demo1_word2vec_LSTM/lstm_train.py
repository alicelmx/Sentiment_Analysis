...
# 分词并去掉换行符 
def tokenizer(text):
    sentences = [jieba.lcut(sentence.replace('\n','')) for sentence in text]
    # print text[:3]
    # 加载停用词表
    stopwords = [line.strip().decode('utf-8') for line in open('./data/stopWord.txt').readlines() ]
    # print stopwords[:10]
...
def train_lstm(n_symbols,embedding_weights,x_train,y_train,x_test,y_test):
    ...
    # loss   accuary
    # [0.8195622615646898, 0.7321005214894196]
    # [0.7657318733042594, 0.7833096253866265]
